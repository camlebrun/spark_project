...
df = pd.read_csv("app/Data/for_streamlit/df_top_10.csv")
...
df2 = pd.read_csv("app/Data/for_streamlit/top_10_CA.csv")
...
df_top_10.write.option("header", "true").csv('app/Data/df_top_10.exp')
...
df_top_10_CA.show()
df_top_10_CA.write.option("header", "true").csv('app/Data/df_top_10_CA.exp')'''
