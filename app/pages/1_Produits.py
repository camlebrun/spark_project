...
df = pd.read_csv("app/Data/for_streamlit/top3.csv")
df.set_index('Nom_produit', inplace=True)
st.write("Top 3 des ventes par magasin")
st.dataframe(df, width= 1000)

df_ca = pd.read_csv("app/Data/for_streamlit/top3_ca.csv")
...
df_top_3.write.option("header", "true").csv('app/Data/df_top_3.exp')
...
df_top_3_CA.write.option("header", "true").csv('app/Data/df_top_3_CA.exp')
'''
